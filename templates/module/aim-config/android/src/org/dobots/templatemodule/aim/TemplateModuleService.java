...
public class TemplateModuleService extends Service {
	private static final String TAG = "TemplateModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			TemplateModule aim = new TemplateModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("TemplateModule");
	}
